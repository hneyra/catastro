...
import kamayuk.catastro.catastro.aplicacion.RegistrarOcupacion;
...
class TitularidadYOcupacionFronteraTest {
    ...
    void sinObservacionNoSeRegistra() throws Exception {
        ...
        MvcResult rechazado =
                mvc.perform(
                                post("/catastro/api/v1/catastro/predios/" + predio + "/titulares")
    ...
    void elInquilinoVaYViene() throws Exception {
        ...
        MvcResult creado =
                mvc.perform(
                                post("/catastro/api/v1/catastro/predios/" + predio + "/inquilinos")
                                        .contentType(MediaType.APPLICATION_JSON)
                                        .content(
                                                """
        ...
        MvcResult fin =
                mvc.perform(
                                put("/catastro/api/v1/catastro/predios/"
                                                + predio
                                                + "/inquilinos/"
                                                + inquilinoId)
                                        .contentType(MediaType.APPLICATION_JSON)
        ...
        MvcResult enMarzo =
                mvc.perform(
                                get("/catastro/api/v1/catastro/predios/" + predio + "/inquilinos")
                                        .param("fecha", "2026-03-15"))
                        .andReturn();
        MvcResult hoy =
                mvc.perform(get("/catastro/api/v1/catastro/predios/" + predio + "/inquilinos"))
                        .andReturn();
        ...
        String cuerpo =
                ...
                """
                        .formatted(
                                ...
                                codigo);
        return mvc.perform(
                        post("/catastro/api/v1/catastro/predios/" + predioId + "/titulares")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(cuerpo))
                .andReturn();
    }
