...
import kamayuk.catastro.nucleo.AcotacionPorPredio;
...
class ConsultaControllerTest {
    ...
    private static final class RepositorioEnMemoria implements FichaCatastralRepository {
        ...
        @Override
        public List<kamayuk.catastro.nucleo.dominio.VersionDeLaFicha> versionesDe(
                long predioId, TipoFicha tipo) {
            return List.of();
        }

        @Override
        public Optional<kamayuk.catastro.nucleo.dominio.FichaCatastral> vigenteA(
                long predioId, TipoFicha tipo, LocalDate fecha) {
            return Optional.empty();
        }

        @Override
        public List<kamayuk.catastro.nucleo.dominio.FichaCatastral> historial(
                long predioId, TipoFicha tipo) {
            return List.of();
        }

        @Override
        public Optional<kamayuk.catastro.nucleo.dominio.FichaCatastral> ultimaVersion(
                long predioId, TipoFicha tipo) {
            return Optional.empty();
        }

        @Override
        public kamayuk.catastro.nucleo.dominio.FichaCatastral insertar(
                kamayuk.catastro.nucleo.dominio.FichaCatastral ficha) {
            throw new UnsupportedOperationException("El transporte no escribe");
        }

        @Override
        public kamayuk.catastro.nucleo.dominio.FichaCatastral cerrar(
                kamayuk.catastro.nucleo.dominio.FichaCatastral ficha) {
            throw new UnsupportedOperationException("El transporte no escribe");
        }

        @Override
        public List<kamayuk.catastro.nucleo.dominio.Construccion> construccionesDe(long fichaId) {
            return List.of();
        }

        @Override
        public List<kamayuk.catastro.nucleo.dominio.OtraInstalacion> instalacionesDe(long fichaId) {
            return List.of();
        }

        @Override
        public Optional<kamayuk.catastro.nucleo.dominio.DetalleDeLaFicha> detalleDe(
