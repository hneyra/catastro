...
class AltaDePredioFronteraTest {
    ...
    void naceSinFicha() throws Exception {
        ...
        MvcResult cola =
                mvc.perform(get("/catastro/api/v1/catastro/predios").param("fichado", "false"))
                        .andReturn();
    ...
    void elAltaExigeRegistro() throws Exception {
        ...
        assertThat(
                        PredioController.class
                                ...
                                .getAnnotation(kamayuk.catastro.autorizacion.RequiereAcceso.class)
                                .privilegio())
                .isEqualTo(kamayuk.catastro.autorizacion.Privilegio.REGISTRO);
    }
    ...
    class CensoDeTitularidad {
        ...
        private String censo(@org.jspecify.annotations.Nullable String titularidad)
                throws Exception {
            var peticion = get("/catastro/api/v1/catastro/predios").param("tamano", "200");
            if (titularidad != null) {
    ...
    private static long crearContribuyente(long municipalidadId, String codigo, String documento)
        ...
        try (Connection app = base.conexion(BaseDeDatosDePrueba.APP)) {
            ...
            try (PreparedStatement consulta =
                    app.prepareStatement(
                            "SELECT id FROM contribuyente_de_prueba WHERE codigo_contribuyente = ?")) {
