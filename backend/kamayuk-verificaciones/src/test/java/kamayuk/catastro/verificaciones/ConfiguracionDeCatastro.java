...
/**
 * Lo que `catastro` declara de si mismo a las barreras de {@code comun-verificaciones}.
 *
...
public final class ConfiguracionDeCatastro implements ConfiguracionDeLasVerificaciones {
     ...
     *
     * <p>La regla {@code NINGUN_SQL_CRUZA_LA_FRONTERA_DE_catastro} necesita saber de quien es la
    ...
    public Set<String> paquetesQueTienenQueExistir() {
        return Set.of("kamayuk.catastro.esquema");
    }
