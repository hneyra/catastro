...
/**
 * Valores unitarios de edificacion: {@code GET
 * /api/v1/catastro/tablas/valores-unitarios?ejercicio=2026} (RF-009).
 *
...
public class ValorUnitarioController {
    ...
    @GetMapping
    public List<ValorUnitarioResource> listar(@RequestParam int ejercicio) {
        try {
            return tablas.valoresUnitarios(new Ejercicio(ejercicio)).stream()
