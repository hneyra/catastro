...
import kamayuk.catastro.catastro.aplicacion.ConsultaDelPlanoCatastral;
...
class PlanoCatastralFronteraTest {
    ...
    private static final String RUTA = "/catastro/api/v1/catastro/predios/plano";
    ...
    void elPlanoExigeElPermisoDeBuscarUnPredio() {
        ...
        assertThat(acceso.privilegio())
                ...
                .isEqualTo(kamayuk.catastro.autorizacion.Privilegio.LECTURA);
    }

    // ------------------------------------------------------------------

    private record RequiereAccesoDelPlano(
            String acceso, kamayuk.catastro.autorizacion.Privilegio privilegio) {}

    private static RequiereAccesoDelPlano accesoDeclarado() {
        kamayuk.catastro.autorizacion.RequiereAcceso anotacion =
                PlanoCatastralController.class.getAnnotation(
                        kamayuk.catastro.autorizacion.RequiereAcceso.class);
