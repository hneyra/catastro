...
class ResumenPredialControllerTest {
    ...
    void devuelveLasCuatroColumnas() throws Exception {
        MvcResult resultado =
                mvc.perform(get("/catastro/api/v1/consultas/resumen-predial")).andReturn();
    ...
    void palabraEs422() throws Exception {
        MvcResult resultado =
                mvc.perform(
                                get("/catastro/api/v1/consultas/resumen-predial")
                                        .param("palabra", "grau"))
                        .andReturn();
    ...
    void elUsoViajaHastaElRepositorio() throws Exception {
        ...
        mvc.perform(get("/catastro/api/v1/consultas/resumen-predial").param("uso", "Todos"))
                .andReturn();
        assertThat(repositorio.ultimoFiltro().uso())
