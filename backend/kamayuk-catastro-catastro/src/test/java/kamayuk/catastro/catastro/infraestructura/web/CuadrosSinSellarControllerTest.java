...
import kamayuk.catastro.catastro.aplicacion.TablasDeValuacion;
import kamayuk.catastro.catastro.dominio.Arancel;
import kamayuk.catastro.catastro.dominio.Depreciacion;
import kamayuk.catastro.catastro.dominio.ValorUnitarioEdificacion;
import kamayuk.catastro.catastro.dominio.ValuacionRepository;
...
class CuadrosSinSellarControllerTest {
    ...
    static Stream<Arguments> lasTresLecturasDeCuadro() {
        return Stream.of(
                Arguments.of("/catastro/api/v1/catastro/tablas/aranceles"),
                Arguments.of("/catastro/api/v1/catastro/tablas/depreciacion"),
                Arguments.of("/catastro/api/v1/catastro/tablas/valores-unitarios"));
    }
    ...
    void unNoEncontradoDeVerdadNoLlevaElMiembro() throws Exception {
        MvcResult resultado =
                mvc.perform(get("/catastro/api/v1/catastro/tablas/aranceles/no-existe-esta-ruta"))
                        .andReturn();
