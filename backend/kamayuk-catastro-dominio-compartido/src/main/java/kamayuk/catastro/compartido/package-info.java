 ...
 * kamayuk.catastro.dominio}, no aqui: {@code TenantContext} es infraestructura con nombre en
 * ingles, y mezclarlo con el vocabulario tributario haria que las reglas de ArchUnit acotadas al
 * dominio revisaran un {@code ThreadLocal}.
 *
...
package kamayuk.catastro.compartido;
