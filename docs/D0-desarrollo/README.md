...
Cómo montar el ambiente local de `catastro`, arrancarlo, depurarlo y probarlo. Escrito para quien
...
```bash
cd ..                                                   # el directorio que contiene a catastro/
