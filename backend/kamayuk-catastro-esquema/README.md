...
```bash
./gradlew :kamayuk-catastro-esquema:test
```
...
así que dos corridas contra el mismo motor por el camino de `kamayuk.pruebas.postgres.url` se la
