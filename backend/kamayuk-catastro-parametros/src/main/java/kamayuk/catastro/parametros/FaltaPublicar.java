...
import kamayuk.catastro.web.ParametroQueFalta;
 ...
 *
 * <h2>Por que vive en {@code kamayuk-catastro-parametros}</h2>
 *
 * <p>Porque es el unico modulo que puede nombrar a la vez las dos mitades: {@link
 * ParametroSinPublicar} —suyo— y {@link ProblemaDeNegocio} de {@code kamayuk-catastro-plataforma},
 * del que todo contexto depende. Al reves no se puede: {@code kamayuk-catastro-plataforma} es la
 * base del grafo y no depende de ningun contexto acotado, asi que {@code kamayuk.catastro.web} no
 * puede nombrar {@code ParametroSinPublicar} (lo dice el javadoc de {@link ParametroQueFalta}).
 *
...
public final class FaltaPublicar {
     ...
     * esta sellado» pondria las dos cosas bajo el mismo codigo justo en la ruta donde conviven, y
     * el discriminador tendria que hacer solo el trabajo que hoy hacen entre los dos.
     *
     ...
     * kamayuk-catastro-dominio-compartido} y no sabe de que ejercicio salieron las politicas —no
