...
import kamayuk.catastro.catastro.aplicacion.ConsultaDeSectores;
import kamayuk.catastro.catastro.aplicacion.RegistrarManzana;
import kamayuk.catastro.catastro.aplicacion.RegistrarSector;
...
class SectorControllerTest {
    ...
    void devuelveLaPaginaEnLaFormaUnica() throws Exception {
        MvcResult resultado = mvc.perform(get("/catastro/api/v1/catastro/sectores")).andReturn();
    ...
    void laEscrituraNoCuenta() throws Exception {
        MvcResult alta =
                mvc.perform(
                                post("/catastro/api/v1/catastro/sectores")
        ...
        MvcResult edicion =
                mvc.perform(
                                put("/catastro/api/v1/catastro/sectores/SC-1")
                                        .contentType(MediaType.APPLICATION_JSON)
                                        .content(
                                                """
    ...
    void elOrdenPorOmisionLoDecideLaOperacion() throws Exception {
        mvc.perform(get("/catastro/api/v1/catastro/sectores")).andReturn();
    ...
    void laBajaEsUnPutConActivoFalse() throws Exception {
        ...
        MvcResult resultado =
                mvc.perform(
                                put("/catastro/api/v1/catastro/sectores/SC-2")
                                        .contentType(MediaType.APPLICATION_JSON)
                                        .content(
                                                """
                                                {"activo":false,
    ...
    void reactivarEsModificacion() throws Exception {
        ...
        MvcResult resultado =
                mvc.perform(
                                put("/catastro/api/v1/catastro/sectores/SC-BAJA")
                                        .contentType(MediaType.APPLICATION_JSON)
                                        .content(
                                                """
                                                {"activo":true,
    ...
    void editarUnSectorQueNoExisteEs404() throws Exception {
        MvcResult resultado =
                mvc.perform(
                                put("/catastro/api/v1/catastro/sectores/SC-NADA")
                                        .contentType(MediaType.APPLICATION_JSON)
                                        .content(
                                                "{\"nombre\":\"Sector X\","
    ...
    void elListadoDeManzanas() throws Exception {
        MvcResult resultado =
                mvc.perform(get("/catastro/api/v1/catastro/sectores/SC-1/manzanas")).andReturn();
    ...
    void elListadoDeManzanasPagina() throws Exception {
        mvc.perform(get("/catastro/api/v1/catastro/sectores/SC-1/manzanas?pagina=1&tamano=2"))
                .andReturn();
    ...
    void elSectorSinManzanasEs200() throws Exception {
        MvcResult resultado =
                mvc.perform(get("/catastro/api/v1/catastro/sectores/SC-2/manzanas")).andReturn();
    ...
    void lasManzanasDeUnSectorInexistenteSon404() throws Exception {
        MvcResult resultado =
                mvc.perform(get("/catastro/api/v1/catastro/sectores/SC-NADA/manzanas")).andReturn();
    ...
    void elAltaDeManzanaResponde201() throws Exception {
        MvcResult resultado =
                mvc.perform(
                                post("/catastro/api/v1/catastro/sectores/SC-1/manzanas")
                                        .contentType(MediaType.APPLICATION_JSON)
                                        .content(
                                                """
                                                {"codigo":"002",
    ...
    void elMismoCodigoEnOtroSectorEntra() throws Exception {
        MvcResult resultado =
                mvc.perform(
                                post("/catastro/api/v1/catastro/sectores/SC-2/manzanas")
                                        .contentType(MediaType.APPLICATION_JSON)
                                        .content(
                                                """
                                                {"codigo":"001",
    ...
    void unaManzanaDeSectorInexistenteEs404() throws Exception {
        MvcResult resultado =
                mvc.perform(
                                post("/catastro/api/v1/catastro/sectores/SC-NADA/manzanas")
                                        .contentType(MediaType.APPLICATION_JSON)
                                        .content(
                                                """
                                                {"codigo":"001",
