...
const CASOS = [
  {
    ...
    cuerpo: 'Cierra #711.\n\nLo de siempre.',
    archivos: ['backend/kamayuk-catastro/src/main/java/kamayuk/catastro/Algo.java'],
    anadido: '',
    esperado: 'rojo',
    dice: '#711',
  },
  {
    ...
    cuerpo: 'Closes #711',
    archivos: ['frontend/src/modulos/catastro/Pantalla.tsx'],
  ...
  },
  {
    ...
    archivos: [
      ...
      'backend/kamayuk-catastro/src/test/java/kamayuk/catastro/AlgoTest.java',
    ],
    anadido: '',
    esperado: 'verde',
  },
