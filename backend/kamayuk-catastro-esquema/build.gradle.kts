// kamayuk-catastro-esquema no es un contexto acotado: contiene las migraciones Flyway, el
...
// reutiliza kamayuk-catastro-plataforma para su prueba con el pool real. Un segundo arranque
...
application {
    mainClass.set("kamayuk.catastro.esquema.Migrador")
