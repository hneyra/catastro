...
import kamayuk.catastro.nucleo.aplicacion.ActualizarCatastro;
import kamayuk.catastro.nucleo.aplicacion.ActualizarFichaCatastral;
import kamayuk.catastro.nucleo.aplicacion.ConsultaDeFichas;
import kamayuk.catastro.nucleo.aplicacion.ConsultaDeLaFichaVigente;
import kamayuk.catastro.nucleo.aplicacion.ConsultaDePredios;
import kamayuk.catastro.nucleo.aplicacion.InscribirFicha;
import kamayuk.catastro.nucleo.aplicacion.RegistrarPredio;
import kamayuk.catastro.nucleo.dominio.ActividadEconomica;
import kamayuk.catastro.nucleo.dominio.BienComun;
import kamayuk.catastro.nucleo.dominio.CatastroRepository;
import kamayuk.catastro.nucleo.dominio.CategoriasConstructivas;
import kamayuk.catastro.nucleo.dominio.Construccion;
import kamayuk.catastro.nucleo.dominio.CriterioDeVia;
import kamayuk.catastro.nucleo.dominio.DetalleDeBienesComunes;
import kamayuk.catastro.nucleo.dominio.DetalleDeLaFicha;
import kamayuk.catastro.nucleo.dominio.DetalleEconomico;
import kamayuk.catastro.nucleo.dominio.DetalleRural;
import kamayuk.catastro.nucleo.dominio.EstadoDeConservacion;
import kamayuk.catastro.nucleo.dominio.EstadoPredio;
import kamayuk.catastro.nucleo.dominio.FichaCatastral;
import kamayuk.catastro.nucleo.dominio.FichaCatastralRepository;
import kamayuk.catastro.nucleo.dominio.FichaEncontrada;
import kamayuk.catastro.nucleo.dominio.FiltroDeFichas;
...
import kamayuk.catastro.nucleo.dominio.ManzanaConConteos;
import kamayuk.catastro.nucleo.dominio.MaterialEstructural;
import kamayuk.catastro.nucleo.dominio.OrigenDeLaFicha;
import kamayuk.catastro.nucleo.dominio.OtraInstalacion;
import kamayuk.catastro.nucleo.dominio.Predio;
import kamayuk.catastro.nucleo.dominio.PredioDelCatastro;
import kamayuk.catastro.nucleo.dominio.Riego;
import kamayuk.catastro.nucleo.dominio.Sector;
import kamayuk.catastro.nucleo.dominio.SectorConConteos;
import kamayuk.catastro.nucleo.dominio.TierraRural;
import kamayuk.catastro.nucleo.dominio.TipoFicha;
import kamayuk.catastro.nucleo.dominio.TipoPredio;
import kamayuk.catastro.nucleo.dominio.TipoVia;
import kamayuk.catastro.nucleo.dominio.Titularidad;
import kamayuk.catastro.nucleo.dominio.VersionDeLaFicha;
import kamayuk.catastro.nucleo.dominio.Via;
import kamayuk.catastro.nucleo.dominio.ViaRepository;
...
class EscrituraDeFichasControllerTest {
    ...
    private static final class PrediosEnMemoria implements CatastroRepository {
        ...
        @Override
        public java.util.List<kamayuk.catastro.nucleo.dominio.LoteDelPlano> lotesDelPlano(
                kamayuk.catastro.nucleo.dominio.FiltroDelPlano filtro, int tope) {
            throw new UnsupportedOperationException("La escritura de fichas no dibuja planos");
        }

        @Override
        public long lotesEnElMarco(kamayuk.catastro.nucleo.dominio.FiltroDelPlano filtro) {
            throw new UnsupportedOperationException("La escritura de fichas no dibuja planos");
        }

        @Override
        public long prediosSinGeometria(kamayuk.catastro.nucleo.dominio.FiltroDelPlano filtro) {
            throw new UnsupportedOperationException("La escritura de fichas no dibuja planos");
        }

        @Override
        public kamayuk.catastro.nucleo.dominio.MarcoDeLoLevantado marcoDeLoLevantado(
                kamayuk.catastro.nucleo.dominio.AcotacionDelPlano acotacion) {
            throw new UnsupportedOperationException("La escritura de fichas no dibuja planos");
        }
    ...
    private static final class FichasEnMemoria implements FichaCatastralRepository {
        ...
        @Override
        public java.util.Optional<kamayuk.catastro.nucleo.dominio.FichaCatastral> porId(
                long fichaId) {
