 ...
 * en cada carga, que es ruido que acaba no mirandose; y, peor, un 404 que el `try_files` de
 * `nginx.conf` convierte en el `index.html` servido como si fuera un guion —el «200 que miente»—,
 * o sea que el fallo mas ruidoso posible se disfrazaria del mas silencioso.
 *
 ...
 * difiere hasta despues del analisis del documento — o sea que llegaria TARDE, cuando la puerta de
 * identidad ya hubiera leido las senias.
 */
window.__KAMAYUK_CATASTRO__ = window.__KAMAYUK_CATASTRO__ || {};
