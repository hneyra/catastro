 ...
 *
 * <p>Admite apuntar a un PostgreSQL ya existente mediante {@code kamayuk.pruebas.postgres.url} (o la
 * variable de entorno {@code KAMAYUK_PRUEBAS_POSTGRES_URL}) para los entornos donde no se puede
...
public final class MotorPostgres implements AutoCloseable {
     ...
     * tambien se puede cambiar con {@code kamayuk.pruebas.postgres.imagen}, y una que no fuera UTF-8
    ...
    private static MotorPostgres conMotorExterno(String urlBase, String usuario, String clave) {
        String nombre = "kamayuk_catastro_prueba_" + UUID.randomUUID().toString().substring(0, 8);
