...
import kamayuk.catastro.catastro.aplicacion.ConsultaDeVias;
import kamayuk.catastro.catastro.aplicacion.RegistrarVia;
...
class ViaControllerTest {
    ...
    void devuelveLaPaginaEnLaFormaUnica() throws Exception {
        MvcResult resultado = mvc.perform(get("/catastro/api/v1/catastro/vias")).andReturn();
    ...
    void losParametrosDePaginacionTienenUnSoloDialecto() throws Exception {
        mvc.perform(get("/catastro/api/v1/catastro/vias")).andReturn();
        ...
        mvc.perform(
                        get("/catastro/api/v1/catastro/vias")
                                .param("pagina", "2")
                                .param("tamano", "5")
    ...
    void unTamanoImposibleEs422() throws Exception {
        MvcResult resultado =
                mvc.perform(get("/catastro/api/v1/catastro/vias").param("tamano", "100000"))
                        .andReturn();
    ...
    void elAltaResponde201() throws Exception {
        MvcResult resultado =
                mvc.perform(
                                post("/catastro/api/v1/catastro/vias")
    ...
    void editarUnaViaCambiaSuNombre() throws Exception {
        MvcResult resultado =
                mvc.perform(
                                put("/catastro/api/v1/catastro/vias/V-1")
                                        .contentType(MediaType.APPLICATION_JSON)
                                        .content(
                                                """
    ...
    void laBajaEsUnPutConActivaFalse() throws Exception {
        ...
        MvcResult resultado =
                mvc.perform(
                                put("/catastro/api/v1/catastro/vias/V-2")
                                        .contentType(MediaType.APPLICATION_JSON)
                                        .content(
                                                """
    ...
    void editarUnaViaQueNoExisteEs404() throws Exception {
        MvcResult resultado =
                mvc.perform(
                                put("/catastro/api/v1/catastro/vias/V-NADA")
                                        .contentType(MediaType.APPLICATION_JSON)
                                        .content(
    ...
    void tipoDeViaDesconocidoEs422() throws Exception {
        MvcResult resultado =
                mvc.perform(get("/catastro/api/v1/catastro/vias").param("tipoDeVia", "AUTOPISTA"))
                        .andReturn();
    ...
    void elSectorSeRechaza() throws Exception {
        MvcResult resultado =
                mvc.perform(get("/catastro/api/v1/catastro/vias").param("sector", "S-01"))
                        .andReturn();
    ...
    void activaSoloAdmiteTrueOFalse() throws Exception {
        MvcResult resultado =
                mvc.perform(get("/catastro/api/v1/catastro/vias").param("activa", "si"))
                        .andReturn();
