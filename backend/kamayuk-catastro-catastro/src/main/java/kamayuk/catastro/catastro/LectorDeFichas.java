 ...
 * kamayuk.catastro.parametros.LectorDeParametros}). Quien consume esto no necesita saber que es una
 ...
 * {@link kamayuk.catastro.catastro.dominio.FichaCatastral} como API publica.
 */
public interface LectorDeFichas {
     ...
     */
    Optional<kamayuk.catastro.dominio.AreaM2> areaDeLaVersion(long fichaId);
}
