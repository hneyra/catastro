...
import kamayuk.catastro.catastro.aplicacion.ActualizarCatastro;
import kamayuk.catastro.catastro.aplicacion.ActualizarFichaCatastral;
import kamayuk.catastro.catastro.aplicacion.ConsultaDeFichas;
import kamayuk.catastro.catastro.aplicacion.ConsultaDeLaFichaVigente;
import kamayuk.catastro.catastro.aplicacion.ConsultaDePredios;
import kamayuk.catastro.catastro.aplicacion.InscribirFicha;
import kamayuk.catastro.catastro.aplicacion.RegistrarPredio;
import kamayuk.catastro.catastro.dominio.ActividadEconomica;
import kamayuk.catastro.catastro.dominio.BienComun;
import kamayuk.catastro.catastro.dominio.CatastroRepository;
import kamayuk.catastro.catastro.dominio.CategoriasConstructivas;
import kamayuk.catastro.catastro.dominio.Construccion;
import kamayuk.catastro.catastro.dominio.CriterioDeVia;
import kamayuk.catastro.catastro.dominio.DetalleDeBienesComunes;
import kamayuk.catastro.catastro.dominio.DetalleDeLaFicha;
import kamayuk.catastro.catastro.dominio.DetalleEconomico;
import kamayuk.catastro.catastro.dominio.DetalleRural;
import kamayuk.catastro.catastro.dominio.EstadoDeConservacion;
import kamayuk.catastro.catastro.dominio.EstadoPredio;
import kamayuk.catastro.catastro.dominio.FichaCatastral;
...
import kamayuk.catastro.catastro.dominio.ManzanaConConteos;
import kamayuk.catastro.catastro.dominio.MaterialEstructural;
import kamayuk.catastro.catastro.dominio.OrigenDeLaFicha;
import kamayuk.catastro.catastro.dominio.OtraInstalacion;
import kamayuk.catastro.catastro.dominio.Predio;
import kamayuk.catastro.catastro.dominio.PredioDelCatastro;
import kamayuk.catastro.catastro.dominio.Riego;
import kamayuk.catastro.catastro.dominio.Sector;
import kamayuk.catastro.catastro.dominio.SectorConConteos;
import kamayuk.catastro.catastro.dominio.TierraRural;
import kamayuk.catastro.catastro.dominio.TipoFicha;
import kamayuk.catastro.catastro.dominio.TipoPredio;
import kamayuk.catastro.catastro.dominio.TipoVia;
import kamayuk.catastro.catastro.dominio.Titularidad;
import kamayuk.catastro.catastro.dominio.VersionDeLaFicha;
import kamayuk.catastro.catastro.dominio.Via;
import kamayuk.catastro.catastro.dominio.ViaRepository;
...
class EscrituraDeFichasControllerTest {
    ...
    class Alta {
        ...
        void elAltaResponde201() throws Exception {
            MvcResult resultado =
                    mvc.perform(
                                    post("/catastro/api/v1/catastro/fichas/urbana")
        ...
        void sobreUnPredioExistenteNoSeCreaOtro() throws Exception {
            ...
            MvcResult resultado =
                    mvc.perform(
                                    post("/catastro/api/v1/catastro/fichas/economica")
                                            .contentType(MediaType.APPLICATION_JSON)
                                            .content(
                                                    """
        ...
        void lasCuatroRutasInscribenSuTipo() throws Exception {
            ...
            for (Map.Entry<String, String> ruta : porRuta.entrySet()) {
                ...
                MvcResult resultado =
                        mvc.perform(
                                        post("/catastro/api/v1/catastro/fichas/" + ruta.getKey())
                                                .contentType(MediaType.APPLICATION_JSON)
                                                .content(
                                                        "{\"codRefCatastral\":\""
                                                                + codigo
        ...
        void unDetalleDeOtroTipoEs422() throws Exception {
            MvcResult resultado =
                    mvc.perform(
                                    post("/catastro/api/v1/catastro/fichas/rural")
                                            .contentType(MediaType.APPLICATION_JSON)
                                            .content(
                                                    """
                                                    {"codRefCatastral":"25010100100100101010001",
    ...
    class Actualizacion {
        ...
        void elPutVersiona() throws Exception {
            MvcResult resultado =
                    mvc.perform(
                                    put("/catastro/api/v1/catastro/fichas/"
                                                    + PREDIO_CON_FICHA
                                                    + "/actualizacion")
                                            .contentType(MediaType.APPLICATION_JSON)
                                            .content(
        ...
        void elDetalleSigueLaMismaRegla() throws Exception {
            ...
            mvc.perform(
                            put("/catastro/api/v1/catastro/fichas/rural/"
                                            + PREDIO_SIN_FICHA
                                            + "/actualizacion")
                                    .contentType(MediaType.APPLICATION_JSON)
                                    .content(
        ...
        void unPredioSinFichaDeEseTipoEs404() throws Exception {
            MvcResult resultado =
                    mvc.perform(
                                    put("/catastro/api/v1/catastro/fichas/economica/"
                                                    + PREDIO_SIN_FICHA
                                                    + "/actualizacion")
                                            .contentType(MediaType.APPLICATION_JSON)
                                            .content(
    ...
    class ListadoDePredios {
        ...
        void losCuatroFiltrosViajan() throws Exception {
            MvcResult resultado =
                    mvc.perform(
                                    get("/catastro/api/v1/catastro/predios")
        ...
        void sinFiltrosNingunoViaja() throws Exception {
            mvc.perform(get("/catastro/api/v1/catastro/predios")).andReturn();
        ...
        void unFichadoQueNoEsBooleanoEs422() throws Exception {
            MvcResult resultado =
                    mvc.perform(get("/catastro/api/v1/catastro/predios").param("fichado", "si"))
                            .andReturn();
        ...
        void unEstadoDesconocidoEs422() throws Exception {
            MvcResult resultado =
                    mvc.perform(get("/catastro/api/v1/catastro/predios").param("estado", "ANULADO"))
                            .andReturn();
    ...
    class BajaDelPredio {
        ...
        void laBajaRetiraElPredio() throws Exception {
            MvcResult resultado =
                    mvc.perform(
                                    post("/catastro/api/v1/catastro/predios/"
                                                    + predios.idDe(PREDIO_CON_FICHA)
                                                    + "/baja")
                                            .contentType(MediaType.APPLICATION_JSON)
                                            .content(
        ...
        void unPredioInexistenteEs404() throws Exception {
            MvcResult resultado =
                    mvc.perform(
                                    post("/catastro/api/v1/catastro/predios/99999/baja")
                                            .contentType(MediaType.APPLICATION_JSON)
                                            .content(
                                                    """
    ...
    class Lectura {
        ...
        void laCabeceraLlevaSusTresCampos() throws Exception {
            ...
            MvcResult resultado =
                    mvc.perform(get("/catastro/api/v1/catastro/fichas/urbana/" + PREDIO_SIN_FICHA))
                            .andReturn();
        ...
        void laActividadLlevaSusFechas() throws Exception {
            ...
            MvcResult resultado =
                    mvc.perform(
                                    get(
                                            "/catastro/api/v1/catastro/fichas/economica/"
                                                    + PREDIO_SIN_FICHA))
                            .andReturn();
        ...
        void elBienComunLlevaSuAnio() throws Exception {
            ...
            MvcResult resultado =
                    mvc.perform(
                                    get(
                                            "/catastro/api/v1/catastro/fichas/bienes-comunes/"
                                                    + PREDIO_SIN_FICHA))
                            .andReturn();
        ...
        void elGrupoDeTierraLlevaSuAreaComun() throws Exception {
            ...
            MvcResult resultado =
                    mvc.perform(get("/catastro/api/v1/catastro/fichas/rural/" + PREDIO_SIN_FICHA))
                            .andReturn();
    ...
    private static final class PrediosEnMemoria implements CatastroRepository {
        ...
        @Override
        public java.util.List<kamayuk.catastro.catastro.dominio.LoteDelPlano> lotesDelPlano(
                kamayuk.catastro.catastro.dominio.FiltroDelPlano filtro, int tope) {
            throw new UnsupportedOperationException("La escritura de fichas no dibuja planos");
        }

        @Override
        public long lotesEnElMarco(kamayuk.catastro.catastro.dominio.FiltroDelPlano filtro) {
            throw new UnsupportedOperationException("La escritura de fichas no dibuja planos");
        }

        @Override
        public long prediosSinGeometria(kamayuk.catastro.catastro.dominio.FiltroDelPlano filtro) {
            throw new UnsupportedOperationException("La escritura de fichas no dibuja planos");
        }

        @Override
        public kamayuk.catastro.catastro.dominio.MarcoDeLoLevantado marcoDeLoLevantado(
                kamayuk.catastro.catastro.dominio.AcotacionDelPlano acotacion) {
            throw new UnsupportedOperationException("La escritura de fichas no dibuja planos");
        }
