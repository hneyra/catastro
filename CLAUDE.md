...
| Su esquema | **Existe.** `V1__baseline.sql` (ADR-0032), `V2` —la copia local de conjuntos sellados—, `V3` —la guarda del arancel—, `V4`, `V5` —el buzón de salida— y **`V6`** —el CUC del SNCP y `frente_predio` (ADR-0036, que cierra D-10)— |
...
backend/                Gradle. Java 25, Spring Boot 4 cuando llegue el negocio
  ...
  kamayuk-catastro-grd/         el SEGUNDO contexto acotado (#5): zona de riesgo, faja marginal e ITSE
