 ...
 *
 * <p>{@code rentas} mantiene una proyeccion de este padron —{@code predio_ref}, {@code ficha_ref}—
 * que se alimenta de eventos. Una proyeccion alimentada por eventos se desincroniza: un evento que
 * se perdio, uno que llego dos veces, uno que se aplico en el orden equivocado. Y <b>no se
 * nota</b>: la fila esta, tiene la forma correcta y dice otra cosa. La pregunta que hay que poder
 * contestar delante de un contribuyente —«¿por que esta ficha dice esta direccion?»— se contesta
 * comparando, y comparar el padron entero cada dia es leer dos veces todo el catastro.
 *
