...
/**
 * Lo que {@code catastro} le pide a {@code normativa}, publicado para que su CI lo comprueba.
 *
 ...
 *
 * <p><b>Este contrato es identico al que publica {@code rentas}</b>, y no por copia: los dos {@code
 * ClienteHttpDeNormativa} son el mismo archivo con otro paquete —22 lineas de diferencia, todas de
 * {@code import}—. Se declaran por separado porque el proveedor tiene que saber quien pide: el dia
 * que uno de los dos deje de descargar un ambito, su archivo lo dira y el del otro no.
 */
@DisplayName("Contrato que catastro consume de normativa")
public class ContratoQueConsumeDeNormativa extends ContratoQueSePublicaTestBase {
    ...
    protected ContratoDelConsumidor contrato() {
        ...
        return new ContratoDelConsumidor("catastro", "normativa", "/normativa/api/v1", operaciones);
    }
