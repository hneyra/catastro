 ...
 * cuanto le corresponde, nada mas. No es {@code kamayuk.catastro.catastro.dominio.Titularidad} —ese
 * tipo vive en un subpaquete y Spring Modulith lo trata como interno—, y tampoco su copia: de la
