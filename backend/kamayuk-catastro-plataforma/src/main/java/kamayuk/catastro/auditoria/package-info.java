 ...
 *
 * <p>Modulo propio y compartido, colgando de {@code kamayuk.catastro}, por lo mismo que {@code
 * dominio} y {@code persistencia}: los doce contextos lo llaman, y para Spring Modulith un
 * subpaquete es interno a su modulo.
 *
 * <h2>Las tres barreras, de la mas externa a la mas interna</h2>
 *
 * <ol>
 *   <li>El tipo {@link kamayuk.catastro.dominio.Observacion}, que no se puede construir vacio, y la
