 ...
 * {@link kamayuk.catastro.parametros.aplicacion.AdministrarParametros#sellar} la copia a la cache
        ...
        try (Statement sentencia = conexion.createStatement()) {
            ...
            sentencia.execute(
                    ...
                    BEGIN
                        ...
                        -- `normativa_valor_referencial` NO se copia, y no es un olvido: catastro
                        -- no cachea el anexo vehicular. Es de `rentas`, y `V2` de este
                        -- repositorio no crea esa tabla. `valor_referencial_de_prueba` se queda
                        -- para que una prueba que siembra un conjunto entero no tenga que saber
                        -- que mitad del conjunto usa cada sistema.
