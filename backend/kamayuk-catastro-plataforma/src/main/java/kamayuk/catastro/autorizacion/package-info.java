 ...
 *
 * <p>Los doce contextos declaran su acceso con {@link
 * kamayuk.catastro.autorizacion.RequiereAcceso}, asi que la anotacion y el enum tienen que estar en
 * un modulo que todos puedan importar. Si vivieran en {@code kamayuk-catastro-seguridad}, cada
 * contexto dependeria de el —lo que ARQ-01 admite— pero {@code kamayuk-catastro-seguridad} no
 ...
 * kamayuk.catastro.autorizacion.ComprobadorDeAcceso}—, y en {@code kamayuk-catastro-seguridad} la
