...
class FichaControllerFronteraTest {
    ...
    void laFichaUrbanaSeLee() throws Exception {
        MvcResult resultado =
                mvc.perform(get("/catastro/api/v1/catastro/fichas/urbana/" + CODIGO)).andReturn();
    ...
    void elCodigoInexistenteSeDistingue() throws Exception {
        MvcResult resultado =
                mvc.perform(get("/catastro/api/v1/catastro/fichas/urbana/23010100010001000109999"))
                        .andReturn();
    ...
    void elPredioSinEsaFichaSeDistingue() throws Exception {
        MvcResult resultado =
                mvc.perform(get("/catastro/api/v1/catastro/fichas/rural/" + CODIGO)).andReturn();
