    ...
    private FichaCatastral vigenteDe(String codigo) {
        long predioId =
                new PrediosPorCodigo(catastro)
                        .identificadorDe(
                                kamayuk.catastro.dominio.CodigoReferenciaCatastral.de(codigo))
                        .orElseThrow();
    ...
    private void inscribir(String codigo, TipoFicha tipo, String direccion, String lote) {
        ...
        inscribir.inscribir(
                ...
                new InscribirFicha.DatosDeLaFicha(
                        tipo,
                        kamayuk.catastro.dominio.AreaM2.de("180.50"),
                        "Casa habitacion",
                        null,
                ...
                new InscribirFicha.DatosDelTitular(
                        "C-000001",
                        kamayuk.catastro.catastro.dominio.CondicionDeTitularidad.PROPIETARIO_UNICO,
                        null,
                        "DJ-DEMO-0001"),
                porque());
    }
