...
class MarcoDelPlanoFronteraTest {
    ...
    private static final String RUTA = "/catastro/api/v1/catastro/predios/plano/marco";
    private static final String RUTA_DEL_PLANO = "/catastro/api/v1/catastro/predios/plano";
