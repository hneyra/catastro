...
public final class CorpusDeNormativa {
     ...
     * proceso de prueba: {@code rentas/backend/kamayuk-catastro-<contexto>}. De ahi a la carpeta
     * que contiene los seis repositorios hay tres saltos, no dos — y equivocarse en uno no da
     * «archivo no encontrado» en la asercion sino un {@code ExceptionInInitializerError} en el
     * campo estatico, que es un sintoma que no se parece a su causa.
     */
