...
// plugin de Spring Boot: solo kamayuk-catastro-aplicacion produce un artefacto ejecutable.
...
dependencies {
    ...
    // SET LOCAL). Vive en kamayuk-catastro-plataforma, que declara `api` sobre
