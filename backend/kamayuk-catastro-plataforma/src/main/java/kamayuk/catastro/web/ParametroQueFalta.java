 ...
 *
 * <p>{@code kamayuk.catastro.web} vive en {@code kamayuk-catastro-plataforma}, que no depende —ni
 * debe— de {@code kamayuk-catastro-parametros}, que es un contexto acotado. Quien traduce la
 * excepcion es el controlador de su modulo, y lo que cruza la frontera es texto.
 */
